...
export function ProfilePage() {
    ...
    const displayNameInput = formContainer.querySelector('#display_name');
    const avatarUrlInput = formContainer.querySelector('#avatar_url'); // Ajouté
    const messageDiv = formContainer.querySelector('#profile-message');
    const saveButton = formContainer.querySelector('#save-profile-button');
