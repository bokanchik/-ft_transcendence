...
export function RegisterPage() {
    ...
    const displayNameInput = container.querySelector('#display_name');
    const passwordInput = container.querySelector('#password');
    const confirmPasswordInput = container.querySelector('#confirm_password');
    const avatarUrlInput = container.querySelector('#avatar_url');
    ...
    form.addEventListener('submit', async (event) => {
        ...
        const registrationResult = await attemptRegister(credentials);
