...
// //    (Remplace celles-ci par tes imports réels plus tard)
// function renderHomePage(): HTMLElement {
//     const div = document.createElement('div');
//     div.innerHTML = `
//         <h1 class="text-3xl font-bold text-center p-8">Page d'Accueil</h1>
//         <p class="text-center">Bienvenue sur King-Pong (version simple SPA)!</p>
//         <div class="text-center mt-4">
//             <a href="/users" data-link class="text-blue-500 hover:underline">Voir les utilisateurs</a>
//         </div>
//     `;
//     return div;
// }
...
//     const div = document.createElement('div');
//     // Normalement, tu appellerais fetchUsers et UserList ici
//     div.innerHTML = `
//         <h1 class="text-3xl font-bold text-center p-8">Page Utilisateurs</h1>
//         <p class="text-center">La liste des utilisateurs devrait s'afficher ici.</p>
//         <div id="user-list-placeholder" class="mt-4 p-4 border rounded">Chargement...</div>
//         <div class="text-center mt-4">
//             <a href="/" data-link class="text-blue-500 hover:underline">Retour à l'accueil</a>
//         </div>
//     `;
//     // Simule un chargement asynchrone simple (remplace par ton vrai fetch)
//     setTimeout(() => {
//         const placeholder = div.querySelector('#user-list-placeholder');
//         if (placeholder) {
//             placeholder.innerHTML = 'Utilisateur 1, Utilisateur 2, Utilisateur 3 (Données fictives)';
//             placeholder.classList.remove('border'); // Enlève le style "chargement"
//         }
//     }, 1000);
//     return div;
// }
...
//     '/': renderHomePage,
//     '/index.html': renderHomePage, // Au cas où
// //    '/users': HomePage,
// //    '/users': renderUsersPage,
//     '/users': UsersPage,
//     '/users.html': renderUsersPage // Au cas où
//     // Ajoute d'autres routes simples ici si besoin
// };
