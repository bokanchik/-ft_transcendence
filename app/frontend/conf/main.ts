...
export async function router() {
    ...
    appContainer.innerHTML = `
	<div class="fixed w-screen h-screen pointer-none">
		<div class="rotate-parent w-full max-w-[90vw] ">
			<div class="rotate-hover">
				<svg class="none w-80 h-80 static" width="405" height="352" viewBox="0 0 405 352" fill="none" xmlns="http://www.w3.org/2000/svg">
					<g id="Plant1">
