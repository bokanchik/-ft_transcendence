...
export async function initLocalGame(config) {
 ...
 */
export async function createLocalMatch(alias1, alias2, isTournament) {
    try {
...
async function fetchTournamentPlayers(players) {
    try {
