...
export async function handleOnlineGame(display_name, userId, container, button, title) {
...
export async function initOnlineGame(display_name, userId, buttonsContainer, title) {
    ...
    socket.on('matchFound', async ({ matchId, displayName, side, opponent }) => {
