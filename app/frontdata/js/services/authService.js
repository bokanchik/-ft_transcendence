...
import { GetMatchByUserIdRouteSchema } from '../shared/schemas/matchesSchemas.js';
...
export function setUserDataInStorage(user) {
 ...
 */
export async function fetchMatchHistoryForUser(userId) {
 ...
 */
export async function verifyTwoFactorLogin(token) {
    try {
 ...
 */
export async function verify2FASetup(token) {
    const payload = { token };
