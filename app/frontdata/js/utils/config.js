...
export const config = {
    api: {
        users: {
            ...
            byId: (userId) => `${USER_API_PREFIX}/${userId}`, // URL_USER
            me: `${USER_API_PREFIX}/me`, // URL_USER_ME
            matchesByUserId: (userId) => `${USER_API_PREFIX}/${userId}/matches`, // URL_USER_MATCH
            twoFa: {
        ...
        friends: {
            ...
            acceptRequest: (friendshipId) => `${USER_API_PREFIX}/friends/requests/${friendshipId}/accept`, // URL_FRIEND_ACCEPT
            declineRequest: (friendshipId) => `${USER_API_PREFIX}/friends/requests/${friendshipId}/decline`, // URL_FRIEND_DECLINE
            cancelRequest: (friendshipId) => `${USER_API_PREFIX}/friends/requests/${friendshipId}/cancel`, // URL_FRIEND_CANCEL
            remove: (friendshipId) => `${USER_API_PREFIX}/friends/${friendshipId}/remove`, // URL_FRIEND_REMOVE
        },
        game: {
            match: (matchId) => matchId ? `${GAME_API_PREFIX}/match/remote/${matchId}` : `${GAME_API_PREFIX}/match`, // URL_MATCH
            matchHistory: (userId) => `${GAME_API_PREFIX}/history/${userId}`, // URL_MATCH_USER
        }
    }
};
