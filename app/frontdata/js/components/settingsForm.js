...
export function SettingsForm(props) {
    ...
    formElement.append(usernameField, emailField, displayNameField, avatarUrlField, languageField, securityTitle, twoFaToggleContainer, twoFaSetupContainer, submitContainer);
