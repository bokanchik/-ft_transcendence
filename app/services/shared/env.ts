...
const envSchema = z.object({
	...
	URL_ALL_USERS: z.string().min(1, "URL_ALL_USERSURL_ALL_USERS is required"),
	URL_USER: z.string().min(1, "URL_USERURL_USER is required"),
	URL_USER_MATCH: z.string().min(1, "URL_USER_MATCHURL_USER_MATCH is required"),
